    ...
    if (strlen($_POST['username']) > 0) {
        ...
        if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['address']) && isset($_POST['city']) && isset($_POST['phone'])) {
            if ((strlen($_POST['name']) > 0) && (strlen($_POST['email']) > 0) && (strlen($_POST['address']) > 0) && (strlen($_POST['city']) > 0) && (strlen($_POST['phone']) > 0)) {
                ...
                $stmt = $pdo->prepare('INSERT INTO donor (name, email, address, city_id, phone) VALUES (:nm, :em, :add, :ci, :ph)');
                $stmt->execute(array(
                    ':nm' => $_POST['name'],
                    ':em' => $_POST['email'],
                    ':add' => $_POST['address'],
...
<body class="text-center">
    ...
    <div class="container">
        ...
        <a class="btn btn-link mt-3" href="../login/donorLogin.php">Already have an account? Log in »</a>
    </div>
